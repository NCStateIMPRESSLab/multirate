...
from model_multirate_scsnet import multirate_model_scsnet;
# measurement_csnet, multirate_base_layer, multirate_enhancement_layer
...
with tf.device(DEVICE):
    ...
    # Defining the model
    multirate_model = multirate_model_scsnet(IMAGE_SIZE, BLOCK_SIZE, nB, NUM_CHANNEL);    # Calling the model
...
OUTPUT_ADDRESS = "./models/multirate_scsnet_"+str(BLOCK_SIZE);
